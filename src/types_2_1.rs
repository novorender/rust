...
#[wasm_bindgen(js_name = TestureSemantic_2_1)]
#[derive(Clone, Copy, Debug, Hash, Eq, PartialEq)]
#[cfg_attr(feature= "checked_types", derive(CheckedBitPattern))]
#[repr(u8)]
#[derive(serde::Serialize)]
...
#[wasm_bindgen(js_name = Float3_2_1)]
#[derive(Clone, Copy, StructOfArray)]
#[derive(serde::Serialize)]
pub struct Float3 {
    pub x: f32,
...
#[wasm_bindgen(js_name = Double3_2_1)]
#[derive(Clone, Copy, StructOfArray)]
#[derive(serde::Serialize)]
pub struct Double3 {
    pub x: f64,
...
#[wasm_bindgen(js_name = AABB_2_1)]
#[derive(Clone, Copy, StructOfArray)]
#[derive(serde::Serialize)]
pub struct AABB {
    #[soa_nested]
    #[serde(with = "crate::parser::_2_1::float3_seq_serializer")]
    #[wasm_bindgen(skip)]
    pub min: Float3,
    #[soa_nested]
    #[serde(with = "crate::parser::_2_1::float3_seq_serializer")]
...
/// Bounding sphere.
#[wasm_bindgen(js_name = BoundingSphere_2_1)]
#[derive(Clone, Copy, StructOfArray)]
#[derive(serde::Serialize)]
...
#[wasm_bindgen(js_name = Bounds_2_1)]
#[derive(Clone, Copy, StructOfArray)]
#[derive(serde::Serialize)]
pub struct Bounds {
    #[soa_nested]
